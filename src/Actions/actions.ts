...
export const SUBMIT_NEW_LIST = 'SUBMIT_NEW_LIST' as const;
export const SELECT_ACTIVE_BOARD = 'SELECT_ACTIVE_BOARD' as const;
export const SUBMIT_NEW_CARD = 'SUBMIT_NEW_CARD' as const;